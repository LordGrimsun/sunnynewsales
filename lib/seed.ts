...
const leadMagnets: LeadMagnet[] = [
  {
    id: 'gmb-drop001-access',
    name: 'GRABMYBITCH Drop 001 · VIP Lookbook & Early Access',
    offer: '2-hour priority checkout window + 15% VIP code for Heavyweight Boxy Tees & Hoodies',
    url: 'https://grabmybitch.com/drop001-vip',
    status: 'live',
    captures: 'email',
    destination: 'Newsletter · VIP Drop List',
    source: 'TikTok & IG Reels · "Drop 001 Vault is opening" (comment DROP)',
    launchedAt: '2026-09-19',
    origin: 'seed',
    notes: 'VIP drop access for zero-inventory Printify/Shopify streetwear dropshipping.',
  },
  {
    id: 'gmb-fit-guide',
    name: 'GRABMYBITCH Streetwear Heavyweight Fit & Sizing Matrix',
    offer: 'Boxy cut, drop shoulder measurements, and wash test benchmarks',
    url: 'https://grabmybitch.com/fit-guide',
    status: 'live',
    captures: 'email',
    destination: 'Newsletter · Size Guide Flow',
    source: 'Shopify PDP popup + IG highlight',
    launchedAt: '2026-09-18',
    origin: 'seed',
    notes: 'Keeps return rate on dropshipped apparel below 1.5%.',
  },
  {
    id: 'operator-stack',
    name: 'GRABMYBITCH Dropshipping Operator Stack',
    offer: 'Every layer of the clothing dropshipping agent stack: Shopify, Printify, Stripe, Klaviyo',
    url: 'https://stack.example.com',
    status: 'live',
    captures: 'email',
    destination: 'Newsletter · main list',
    source: 'Carousel · "One person, an automated clothing brand" (comment STACK)',
    launchedAt: '2026-08-12',
    origin: 'seed',
    notes: 'Ungated. The automated e-commerce architecture powering GRABMYBITCH.',
  },
  {
    id: 'automation-teardown',
    name: 'The Dropshipping Automation Teardown',
    offer: 'A clothing dropshipping workflow pulled apart step by step: design, mockup, routing, fulfillment',
    url: 'https://teardown.example.com',
    status: 'live',
    captures: 'email',
    destination: 'Newsletter · main list',
    source: 'Short · "Zero-inventory clothing brand automated" (comment TEARDOWN)',
    launchedAt: '2026-08-05',
    origin: 'seed',
    notes: 'Built from the workflows view. Step by step dropshipping blueprint.',
  },
  {
    id: 'cohort-waitlist',
    name: 'GRABMYBITCH Drop 002 Waitlist',
    offer: 'Priority reserve list for upcoming Drop 002 colorways & cut-and-sew jackets',
    ...
    origin: 'seed',
    notes: 'Paused between drops. Reopen when Drop 002 release date is finalized.',
  },
];
...
// threads, inbound + outbound, believable GRABMYBITCH dropshipping customer support tone.
const socialDmMessages: SocialDmMessage[] = [
  // Alex — customer inquiry on sizing
  ['ig-alex', 'Alex Rivera', 'alex.rivera', 'in', 'saw the Drop 001 reel 🔥 what is the sizing on the heavyweight boxy tee?', null, '2026-09-18T14:02:00.000Z'],
  ['ig-alex', 'Alex Rivera', 'alex.rivera', 'out', 'appreciate it! It has a relaxed drop-shoulder cut with pre-shrunk 280GSM cotton. If you want oversized go true to size, size down for fitted.', null, '2026-09-18T14:09:00.000Z'],
  ['ig-alex', 'Alex Rivera', 'alex.rivera', 'in', 'perfect, ordering the black tee & hoodie now 🖤', null, '2026-09-18T14:15:00.000Z'],
  // Jordan — keyword flow "DROP"
  ['ig-jordan', 'Jordan Blake', 'jordanbuilds', 'in', 'DROP', 'DROP', '2026-09-18T12:41:00.000Z'],
  ['ig-jordan', 'Jordan Blake', 'jordanbuilds', 'out', 'boom 💥 here is your secret VIP early access + 15% off code: VIPDROP15 → grabmybitch.com/drop001-vip', 'DROP', '2026-09-18T12:41:20.000Z'],
  ['ig-jordan', 'Jordan Blake', 'jordanbuilds', 'in', 'copped the hoodie! thanks', null, '2026-09-18T13:05:00.000Z'],
  // Priya — shipping time inquiry
  ['ig-priya', 'Priya N', 'priya.builds', 'in', 'hey! how fast does shipping take to California?', null, '2026-09-17T21:12:00.000Z'],
  ['ig-priya', 'Priya N', 'priya.builds', 'out', 'US orders are printed and delivered in 3-5 business days via USPS tracked shipping 📦', null, '2026-09-17T21:30:00.000Z'],
  // Sam — restock inquiry (unreplied → shows as needing attention)
  ['ig-sam', 'Sam Ortiz', 'sam.ortiz.co', 'in', 'will there be a restock of the washed dad cap once Drop 001 sells out?', null, '2026-09-18T15:48:00.000Z'],
...
const socialPosts: SocialPost[] = [
  {
    id: 'post-seed-1',
    caption: 'GRABMYBITCH Drop 001 is officially live. Heavyweight boxy tees and 450GSM hoodies. Limited units before the vault seals. Link in bio ⚡',
    mediaUrl: null,
...
const FUNNEL_JOURNEYS: SeededJourney[] = [
  // — Drop 001 Direct to Consumer (mentorship / launchpad lane) —
  {
    id: 'fc-jake-moreau', name: 'Jake Moreau', venture: 'launchpad-cohort',
    relationship: 'hot', likelihood: 100,
    product: 'GRABMYBITCH Drop 001 — Heavyweight Boxy Tee ($42)', amountUsd: 42,
    touches: [
      ['first_touch', 'organic', 'TikTok reel: "GRABMYBITCH Drop 001 sample unboxing"', 'trakyo', 59],
      ['engaged', 'dm', 'Replied to story CTA — "sizing check on boxy tee"', 'manual', 57],
      ['nurtured', 'email', 'VIP drop email: secret 15% code VIPDROP15', 'manual', 54],
      ['opted_in', 'call', 'Claimed VIP drop window via bio link', 'trakyo', 51],
      ['converted', 'checkout', 'Paid in full — Stripe checkout', 'manual', 49],
    ],
  },
  {
    id: 'fc-priya-shah', name: 'Priya Shah', venture: 'launchpad-cohort',
    relationship: 'warm', likelihood: 95,
    product: 'GRABMYBITCH Drop 001 — Oversized Heavy Hoodie ($78)', amountUsd: 78,
    touches: [
      ['first_touch', 'ads', 'Meta ad: "GRABMYBITCH Heavyweight 450GSM Fleece"', 'meta-ads', 45],
      ['engaged', 'ads', 'Watched video lookbook 80% — retarget pool', 'meta-ads', 45],
      ['opted_in', 'webinar', 'Claimed early drop reservation', 'manual', 42],
      ['converted', 'checkout', 'Paid — Stripe checkout', 'manual', 40],
    ],
  },
  {
    id: 'fc-danny-okafor', name: 'Danny Okafor', venture: 'launchpad-cohort',
    relationship: 'hot', likelihood: 100,
    product: 'GRABMYBITCH Drop 001 — Streetwear Box Bundle ($148)', amountUsd: 148,
    touches: [
      ['first_touch', 'organic', 'TikTok: "streetwear dropshipping sample review"', 'trakyo', 38],
      ['engaged', 'organic', 'Binged 6 reels, followed, saved lookbook post', 'trakyo', 36],
      ['nurtured', 'ads', 'Retargeting ad: customer fit photos carousel', 'meta-ads', 33],
      ['opted_in', 'call', 'Added complete bundle to cart (Trakyo attributed)', 'trakyo', 30],
      ['converted', 'checkout', 'Paid in full — Stripe checkout', 'manual', 29],
    ],
  },
  {
    id: 'fc-sofia-reyes', name: 'Sofia Reyes', venture: 'launchpad-cohort',
    relationship: 'warm', likelihood: 95,
    product: 'GRABMYBITCH Drop 001 — Washed Dad Cap ($28)', amountUsd: 28,
    touches: [
      ['first_touch', 'organic', 'IG long-form: "styling Drop 001 pieces"', 'trakyo', 31],
      ['engaged', 'email', 'Joined newsletter from IG bio link', 'manual', 30],
      ['nurtured', 'email', 'Newsletter: Drop 001 lookbook preview', 'manual', 26],
      ['opted_in', 'webinar', 'Claimed VIP preorder pass', 'manual', 23],
      ['converted', 'checkout', 'Paid — Stripe checkout', 'manual', 22],
    ],
  },
  {
    ...
    touches: [
      ['first_touch', 'ads', 'Meta ad: "Drop 001 oversized hoodie" (cold traffic)', 'meta-ads', 27],
      ['engaged', 'ads', 'Clicked through, viewed product page 45s', 'meta-ads', 27],
      ['engaged', 'ads', 'Retarget click — added to cart, abandoned', 'meta-ads', 23],
      ['engaged', 'email', 'Abandoned-cart email opened, no reply yet', 'manual', 21],
    ],
  },
  {
    ...
    touches: [
      ['first_touch', 'organic', 'IG carousel: "streetwear essentials Drop 001"', 'trakyo', 24],
      ['engaged', 'dm', 'DMFlow keyword "DROP" → VIP flow', 'manual', 24],
      ['nurtured', 'email', 'Sizing guide delivered, opened', 'manual', 12],
      ['nurtured', 'email', 'Newsletter: sample breakdown clicked', 'manual', 10],
    ],
  },
  {
    ...
    touches: [
      ['first_touch', 'organic', 'TikTok: "streetwear fit check" went semi-viral', 'trakyo', 4],
      ['engaged', 'organic', 'Profile visit → followed + commented', 'trakyo', 4],
      ['nurtured', 'dm', 'DM convo — asked about sizing & shipping', 'manual', 3],
      ['opted_in', 'call', 'Cart loaded for next drop (Trakyo attributed)', 'trakyo', 2],
    ],
  },
  {
    ...
    touches: [
      ['first_touch', 'organic', 'IG reel: "Drop 001 design studio"', 'trakyo', 84],
      ['engaged', 'dm', 'Story-reply convo, asked for bundle discount', 'manual', 80],
      ['engaged', 'email', 'VIP code sent, opened twice', 'manual', 74],
  ...
  },
  {
    ...
    touches: [
      ['first_touch', 'ads', 'Meta ad: "Drop 001 boxy tee" (old campaign)', 'meta-ads', 118],
      ['engaged', 'ads', 'Clicked through, viewed lookbook', 'meta-ads', 118],
      ['engaged', 'dm', 'One-word DM reply, then silence', 'manual', 112],
      ['engaged', 'email', 'Re-engagement email bounced-opened, no click', 'manual', 104],
    ],
  },
  // — Wholesale / Retailer / Collab (Vantage arm) —
  {
    id: 'fc-ava-stone', name: 'Ava Stone — Northwind Retail', venture: 'vantage',
    relationship: 'hot', likelihood: 100,
    product: 'GRABMYBITCH Wholesale — Retailer Preorder (50 Tees)', amountUsd: 1200,
    touches: [
      ['first_touch', 'organic', 'LinkedIn post: autonomous dropshipping supply chain', 'trakyo', 57],
      ['engaged', 'email', 'Replied to newsletter — "want this in our NYC pop-up"', 'manual', 55],
      ['opted_in', 'call', 'Sample pack review call (Trakyo attributed)', 'trakyo', 50],
      ['nurtured', 'email', 'Wholesale invoice + terms sent, viewed 3×', 'manual', 47],
      ['converted', 'checkout', 'Signed — 50% deposit via Stripe invoice', 'manual', 43],
    ],
  },
  {
    id: 'fc-omar-haddad', name: 'Omar Haddad — Pulse Apparel Group', venture: 'vantage',
    relationship: 'warm', likelihood: 95,
    product: 'GRABMYBITCH Collab — Gym Streetwear Capsule (25 Hoodies)', amountUsd: 1250,
    touches: [
      ['first_touch', 'ads', 'Meta ad: "heavyweight gym & streetwear collab"', 'meta-ads', 48],
      ['engaged', 'ads', 'Case-study page dwell 4m — retarget pool', 'meta-ads', 47],
      ['nurtured', 'email', 'Wholesale catalog emailed after form fill', 'manual', 44],
      ['opted_in', 'call', 'Demo call — 3 store locations scoped', 'manual', 41],
      ['converted', 'checkout', 'Collab order live — Stripe subscription', 'manual', 37],
    ],
  },
  {
    id: 'fc-elena-brooks', name: 'Elena Brooks — Harbor Boutique', venture: 'vantage',
    relationship: 'hot', likelihood: 100,
    product: 'GRABMYBITCH Wholesale — Boutique Consignment (30 Tees)', amountUsd: 750,
    touches: [
      ['first_touch', 'organic', 'IG reel: sample unboxing demo', 'trakyo', 31],
      ['engaged', 'dm', 'DM: "can we stock Drop 001 in our boutique?"', 'manual', 30],
      ['opted_in', 'call', 'Wholesale onboarding via link-in-bio (Trakyo attributed)', 'trakyo', 27],
...
const workflows: Workflow[] = [
  {
    id: 'wf-vantage-sales',
    name: 'GRABMYBITCH Dropshipping & Fulfillment Engine',
    subtitle: 'Store order to automated supplier routing, print QA, and tracking delivery.',
    revenueUsd: 140_000,
    order: 0,
    steps: [
      {
        id: 'wf-mer-1',
        title: 'Run Drop 001 viral campaigns',
        detail: '',
        branch: null,
        ownerKind: 'agent',
        ...
        edgeLabel: 'clicks',
        leakUsd: null,
        automation: { title: 'Automated TikTok/Reels product mockups', state: 'live', recoveredUsd: 4200 },
      },
      {
        id: 'wf-mer-2',
        title: 'Customer sizing & order support',
        detail: '',
        branch: null,
        ownerKind: 'agent',
        owner: 'Comms Agent',
        ...
        edgeLabel: 'ordered',
        leakUsd: 12_000,
        automation: { title: 'Auto-sizing concierge & stock check', state: 'suggested', recoveredUsd: 8500 },
      },
      {
        id: 'wf-mer-3',
        title: 'Route orders to Print-on-Demand',
        detail: '',
        branch: null,
        ownerKind: 'human',
        owner: 'Alex · Founder',
      ...
      {
        id: 'wf-mer-4',
        title: 'Print quality check & packing',
        detail: '',
        branch: null,
        ownerKind: 'human',
        owner: 'Alex · Founder',
      ...
      {
        id: 'wf-mer-5',
        title: 'Post-delivery review & repurchase',
        detail: '',
        branch: null,
        ownerKind: 'human',
        owner: 'Alex · Founder',
        ...
        edgeLabel: 'retained',
        leakUsd: 4000,
        automation: { title: 'Automated 15% VIP drop winback', state: 'suggested', recoveredUsd: 4000 },
      },
      {
        id: 'wf-mer-6',
        title: 'Carrier reconciliation & payout',
        detail: '',
        branch: null,
        ownerKind: 'agent',
        ...
        edgeLabel: null,
        leakUsd: null,
        automation: { title: 'Stripe payout to supplier ledger sync', state: 'live', recoveredUsd: 3000 },
      },
    ],
  },
  {
    id: 'wf-lc-delivery',
    name: 'GRABMYBITCH Influencer Seeding & Content Engine',
    subtitle: 'Creator outreach to viral UGC showcase & conversion.',
    revenueUsd: 95_000,
    order: 1,
    steps: [
      {
        id: 'wf-lc-1',
        title: 'Seed apparel to streetwear creators',
        detail: '',
        branch: null,
        ownerKind: 'agent',
        owner: 'GoHighLevel',
        ...
        edgeLabel: 'seeded',
        leakUsd: null,
        automation: { title: 'Automated influencer size & address collection', state: 'live', recoveredUsd: 2500 },
      },
      {
        id: 'wf-lc-2',
        title: 'Track unboxing & review posts',
        detail: '',
        branch: null,
        ownerKind: 'agent',
        owner: 'GoHighLevel',
        ...
        edgeLabel: 'posted',
        leakUsd: 7000,
        automation: { title: 'TikTok & IG tag scraper', state: 'live', recoveredUsd: 5000 },
      },
      {
        id: 'wf-lc-3',
        title: 'Creator affiliate tracking',
        detail: '',
        branch: null,
        ownerKind: 'human',
        owner: 'Alex · Founder',
      ...
      {
        id: 'wf-lc-4',
        title: 'Streetwear VIP community ops',
        detail: '',
        branch: null,
        ownerKind: 'human',
        owner: 'LC Team',
        ...
        edgeLabel: 'engaged',
        leakUsd: 4000,
        automation: { title: 'VIP drop early access community', state: 'suggested', recoveredUsd: 4000 },
      },
      {
        id: 'wf-lc-5',
        title: 'Track ad ROAS & organic attribution',
        detail: '',
        branch: null,
        ownerKind: 'agent',
        owner: 'Trakyo',
        ...
        edgeLabel: null,
        leakUsd: null,
        automation: { title: 'ROAS & attribution sync', state: 'suggested', recoveredUsd: 0 },
      },
    ],
  },
];
...
// first load. Real-ready GRABMYBITCH clothing dropshipping operations.
const SEED_TS = '2026-09-19T12:00:00.000Z';
const agentTasks: AgentTask[] = [
  { id: 'task-seed-1', agentId: 'comms-agent', title: 'Triage customer order inquiries & sizing questions', status: 'open', createdAt: SEED_TS, updatedAt: SEED_TS },
  { id: 'task-seed-2', agentId: 'social-agent', title: 'Draft 3 TikTok hooks for GRABMYBITCH Drop 001 launch', status: 'open', createdAt: SEED_TS, updatedAt: SEED_TS },
  { id: 'task-seed-3', agentId: 'gmail-worker', title: 'Route Print-on-Demand order confirmations to suppliers', status: 'open', createdAt: SEED_TS, updatedAt: SEED_TS },
  { id: 'task-seed-4', agentId: 'adsmith-creative', title: 'Generate 5 UGC streetwear mockups for Heavyweight Boxy Tee ($42)', status: 'open', createdAt: SEED_TS, updatedAt: SEED_TS },
  { id: 'task-seed-5', agentId: 'postly-publisher', title: "Schedule Drop 001 lookbook posts across IG and TikTok", status: 'doing', createdAt: SEED_TS, updatedAt: SEED_TS },
  { id: 'task-seed-6', agentId: 'comms-agent', title: 'Answer 12 sizing DMs for Oversized Heavy Hoodie ($78)', status: 'doing', createdAt: SEED_TS, updatedAt: SEED_TS },
  { id: 'task-seed-7', agentId: 'reelkit-editor', title: 'Render 4K sample unboxing reel with bass hook', status: 'doing', createdAt: SEED_TS, updatedAt: SEED_TS },
  { id: 'task-seed-8', agentId: 'gmail-worker', title: 'Send tracking numbers for dispatched Drop 001 orders', status: 'done', createdAt: SEED_TS, updatedAt: SEED_TS },
  { id: 'task-seed-9', agentId: 'slack-worker', title: 'Post daily supplier fulfillment SLA & tracking digest', status: 'done', createdAt: SEED_TS, updatedAt: SEED_TS },
  { id: 'task-seed-10', agentId: 'social-agent', title: 'Publish Drop 001 countdown carousel to Instagram', status: 'done', createdAt: SEED_TS, updatedAt: SEED_TS },
  { id: 'task-seed-11', agentId: 'postly-publisher', title: 'Sync engagement analytics across TikTok, IG, and Twitter', status: 'done', createdAt: SEED_TS, updatedAt: SEED_TS },
];
 ...
 * per change.
 */
export const SEED_VERSION = '2026-09-19-grabmybitch-dropship';
