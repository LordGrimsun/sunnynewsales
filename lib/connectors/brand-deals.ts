...
export const SEEDED_DEALS: BrandDeal[] = [
  {
    id: 'seed-1', brand: 'Hypebeast Collab (Drop 001)', status: 'Negotiating', tier: 'S',
    dealValueUsd: 7500, budgetUsd: 10000, amountAgreedUsd: null, suggestedRateUsd: 8000,
    paidInFull: false, deadline: '2026-10-15', followUpDate: '2026-09-25',
    contactName: 'Leo Vance', contactEmail: 'leo@hypebeast.example.com', mainChannel: 'Instagram',
    videoType: 'Integration', source: 'Inbound', icpFit: 'Strong',
    notionUrl: 'https://www.notion.so/', lastEdited: '2026-09-18T15:00:00.000Z', seeded: true,
  },
  {
    id: 'seed-2', brand: 'TikTok Fashion Creator (@drippulse)', status: 'New', tier: 'A',
    dealValueUsd: null, budgetUsd: null, amountAgreedUsd: null, suggestedRateUsd: 3500,
    paidInFull: false, deadline: null, followUpDate: '2026-09-22',
    contactName: null, contactEmail: null, mainChannel: 'TikTok',
    videoType: 'Short-form', source: 'Outbound', icpFit: 'Strong',
    notionUrl: 'https://www.notion.so/', lastEdited: '2026-09-17T10:00:00.000Z', seeded: true,
  },
  {
    id: 'seed-3', brand: 'Complex Streetwear Feature', status: 'Filming', tier: 'S',
    dealValueUsd: 12000, budgetUsd: 12000, amountAgreedUsd: 12000, suggestedRateUsd: 11000,
    paidInFull: false, deadline: '2026-10-01', followUpDate: null,
    contactName: 'Marcus Cole', contactEmail: 'marcus@complex.example.com', mainChannel: 'YouTube',
    videoType: 'Dedicated', source: 'Agency', icpFit: 'Strong',
    notionUrl: 'https://www.notion.so/', lastEdited: '2026-09-16T09:00:00.000Z', seeded: true,
  },
  {
    id: 'seed-4', brand: 'Printify Supplier Spotlight', status: 'Paid', tier: 'B',
    dealValueUsd: 3000, budgetUsd: 3000, amountAgreedUsd: 3000, suggestedRateUsd: 3000,
    ...
    notionUrl: 'https://www.notion.so/', lastEdited: '2026-09-10T16:00:00.000Z', seeded: true,
  },
];
