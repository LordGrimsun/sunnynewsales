export function PageHeader({
  ...
  // No descriptions under titles — the operator built it and already knows what it does.
  return (
    <header className={`rise mb-6 flex justify-between gap-4 ${rightWide ? 'items-start' : 'items-end'}`}>
