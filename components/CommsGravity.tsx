  ...
  return (
    <div>
      ...
      <div className="relative">
        <div className="grid grid-cols-3 gap-px overflow-hidden rounded-2xl border border-os-border bg-os-border">
                      ...
                      {band.map(({ item, key }) => {
                        ...
                        return (
                          <button
                            ...
                            className="pressable group relative grid h-9 w-9 shrink-0 place-items-center rounded-full border bg-os-bg"
                            style={{
                              borderColor: color,
                              boxShadow: isSel
      ...
      <div className="mt-3 rounded-2xl border border-os-border-strong bg-os-surface p-3">
        {selected ? (
          <SelectedMessage
            item={selected.item}
            draft={draft}
    ...
    <div>
          ...
          {CONTACT_TIERS.map((t) => {
            ...
            return (
              <button
                ...
                className={`pressable h-6 w-6 rounded font-mono text-[11px] font-bold ${
      ...
      <div className="mt-2.5 flex gap-2">
        ...
        <button
          onClick={onReply}
          disabled={!draft.trim()}
          className="pressable flex shrink-0 items-center gap-1.5 self-end rounded-lg bg-os-text px-3 py-2 text-xs font-bold text-os-bg disabled:opacity-30"
        >
